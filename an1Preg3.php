                     ...
                     <div id="siteNav">
                        <ul>
                           ...
                           <ul class="current-page-parent">
                              ...
                              <li id="active"><a href="an1Preg3.php" class="active no-ch">3</a></li>
...
<div class="iDevice emphasis1" >
    ...
    <form name="true-false-form-0b26" action="#" class="activity-form">
     <div id="taquestion0b10" class="block iDevice_content" align="center">
        <span style="font-size: x-large;">¿Es un cocodrilo?</span>
        <p><img src="https://i.imgur.com/JKsch7t.gif" width="390" height="220" /></p>      
      </div>
        </div>  
    <br><br>
...
<div class="iDevice emphasis1" >
      ...
      <label for="true0b26"><input type="radio" name="option0b26" id="true0b26" onclick="$exe.getFeedback(0,2,'0b26','truefalse')" /> Verdadero</label> 
        </p>
        <p class="iDevice_answer js-required">
      <label for="false0b26"><input type="radio" name="option0b26" id="false0b26" onclick="$exe.getFeedback(1,2,'0b26','truefalse')" /> Falso</label>
      </p>
</form>
 <!-- FIN PREGUNTAS --> 
      <div class="iDevice_feedbacks js-feedback">
          <div id="s0b26" class="feedback js-feedback js-hidden">
          <h4 class="js-sr-av">Retroalimentación</h4>
          <p><strong id="s0b26-result" class="right">Verdadero</strong></p>
          <p><span style="font-size: large;">Es un cocodrilo.</span></p>
          </div>
      </div>
      ...
      <div id='bottomPagination' align="center">
                     <div class="pagination noprt" align="center">
                      <a href="an1Preg4.php" class="next"><span>Siguiente<span> &raquo;</span></span></a>
                     </div>
      </div>
