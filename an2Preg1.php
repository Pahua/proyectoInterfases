                     ...
                     <div id="siteNav">
                        <ul>
                           ...
                           <ul class="current-page-parent">
                              <li id="active"><a href="an2Preg1.php" class="active no-ch">1</a></li>
...
<div class="iDevice emphasis1" >
    ...
    <div class="question">
     ...
     <div id="taquestion0b10" class="block iDevice_content" align="center">
        <span style="font-size: x-large;">¿Es una mosca?</span>
        <p><img src="https://i.imgur.com/Yxftk76.gif" width="390" height="220" /></p>      
      </div>
        </div>  
    <br><br>
...
<div class="iDevice emphasis1" >
      ...
      <label for="true0b16"><input type="radio" name="option0b16" id="true0b16" onclick="$exe.getFeedback(0,2,'0b16','truefalse')" /> Verdadero</label> 
      </p>
      <p class="iDevice_answer js-required">
      <label for="false0b16"><input type="radio" name="option0b16" id="false0b16" onclick="$exe.getFeedback(1,2,'0b16','truefalse')" /> Falso</label>
      </p>
      ...
      <div class="iDevice_feedbacks js-feedback">
        <div id="s0b16" class="feedback js-feedback js-hidden">
      ...
      <div id='bottomPagination' align="center">
                     <div class="pagination noprt" align="center">
                      <a href="an2Preg2.php" class="next"><span>Siguiente<span> &raquo;</span></span></a>
                     </div>
      </div>
