                     ...
                     <div id="siteNav">
                        <ul>
                           ...
                           <ul>
                              ...
                              <li id="active"><a href="vPreg5.php" class="active no-ch">5</a></li>
                           </ul>
                           </li>
...
<div class="iDevice emphasis1" >
    ...
    <form name="multi-choice-form-4_86" action="#" onsubmit="return false" class="activity-form">
        ...
        <p><img src="http://i.imgur.com/4olZ5at.gif" width="390" height="220" style="font-size: 1em;" align="center" /></p>
        </div>
    </div>  
    <br><br>
...
<div class="iDevice emphasis1" >
    ...
    <div class="iDevice_answer">
      ...
      <label for="i7_89" class="sr-av"><a href="#answer-7_89">Opción 1</a></label><input type="radio" name="option7_86" id="i7_89" onclick="$exe.getFeedback(0,3,'7_86','multi')"/>
      </p>
      <div class="iDevice_answer-content" id="answer-7_89"><a name="answer-7_89"></a>
      <div id="taans7_89" class="block iDevice_content">
      <p style="text-align: left;"><span style="font-size: large;">i</span></p>
      </div>
      </div>
      <div class="iDevice_answer">
      <p class="iDevice_answer-field js-required">
      <label for="i7_173" class="sr-av"><a href="#answer-7_173">Opción 2</a></label><input type="radio" name="option7_86" id="i7_173" onclick="$exe.getFeedback(1,3,'7_86','multi')"/>
      </p>
      <div class="iDevice_answer-content" id="answer-7_173"><a name="answer-7_173"></a>
      <div id="taans7_173" class="block iDevice_content">
      <p style="text-align: left;"><span style="font-size: large;">Y</span></p>
      </div>
      </div>
      </div>
      <div class="iDevice_answer">
      <p class="iDevice_answer-field js-required">
      <label for="i7_176" class="sr-av"><a href="#answer-7_176">Opción 3</a></label><input type="radio" name="option7_86" id="i7_176" onclick="$exe.getFeedback(2,3,'7_86','multi')"/>
      </p>
      <div class="iDevice_answer-content" id="answer-7_176"><a name="answer-7_176"></a>
      <div id="taans7_176" class="block iDevice_content">
      <p style="text-align: left;"><span style="font-size: large;">U</span></p>
      </div>
      </div>
      </div>
      </div>
    ...
    <div class="iDevice_feedbacks js-feedback">
      <div id="sa0b7_86" class="feedback js-hidden"><a name="sa0b7_86"></a>
      <div id="taf7_89" class=" iDevice_content">
      <p><span style="font-size: large;">Correcto. Se trata de la letra i / I.</span></p>
      </div>
      </div>
      <div id="sa1b7_86" class="feedback js-hidden"><a name="sa1b7_86"></a>
      <div id="taf7_173" class=" iDevice_content">
      <p><span style="font-size: large;">Incorrecto. Esta no es una vocal</span></p>
      </div>
      </div>
      <div id="sa2b7_86" class="feedback js-hidden"><a name="sa2b7_86"></a>
      <div id="taf7_176" class=" iDevice_content">
      <p><span style="font-size: large;">Incorrecto. Ya aprendimos la seña que le corresponde a esta letra.</span></p>
      </div>
      </div>
    </div><!-- FIN FEEDBACK --> 
    </form>
